...
# print("Данные с прошлого диплома")


# Вычисляем T статистику и p-значение
print(Fore.MAGENTA + "")
print("ФИЗИЧЕСКАЯ АГРЕССИЯ")
T, p = stats.wilcoxon(physicalAggressionBefore, physicalAggressionAfter, alternative='two-sided')
print(f'Т: {T}')
print(f'Асимп. знач. (двухсторонняя): {p}')

print(Fore.CYAN + "")
print("ГНЕВ")
T, p = stats.wilcoxon(AngerBefore, AngerAfter, alternative='two-sided')
print(f'Т: {T}')
print(f'Асимп. знач. (двухсторонняя): {p}')

print(Fore.RED + "")
print("ВРАЖДЕБНОСТЬ")
T, p = stats.wilcoxon(HostilityBefore, HostilityAfter, alternative='two-sided')
print(f'Т: {T}')
print(f'Асимп. знач. (двухсторонняя): {p}')
